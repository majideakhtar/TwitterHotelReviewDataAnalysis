...
public class FrameDictionary {
    ...
    /////mixed starts
     public String getMixDictionaryString(String category){
     try{
         getMixElements = "";
     FileInputStream fis = new FileInputStream(category+"/mixed.txt");
     byte bb[] = new byte[fis.available()];
     fis.read(bb);
     fis.close();
     getMixElements = new String(bb);
     }catch(Exception e){
         System.out.println(e);
     }    
        return posDictionaryString;
